...
<head>
    ...
    <style>
        ...
        .product-card { border: 1px solid #ccc; border-radius: 4px; padding: 16px;
                        width: 220px; box-sizing: border-box; }
        .product-card h3 { margin: 0 0 8px; font-size: 15px; }
        .product-card .price { color: #2e7d32; font-weight: bold; margin-bottom: 6px; }
        .product-card .stock-out { color: #c62828; font-style: italic; }
        .product-card .desc { font-size: 12px; color: #555; margin-bottom: 10px; }
        .add-form { display: flex; align-items: center; gap: 6px; }
        .add-form input[type="number"] { width: 55px; padding: 4px; border: 1px solid #ccc;
                                         border-radius: 3px; }
        ...
        .btn-cart { background: #1565c0; color: white; border-color: #1565c0; }
    </style>
</head>
<body>
<%
...
<% } else {
    ...
    <div class="product-card">
        ...
        <% } else { %>
            ...
            <form class="add-form" action="${pageContext.request.contextPath}/cart" method="post">
